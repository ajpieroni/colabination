...
ActiveRecord::Schema[7.0].define(version: 2023_10_02_165312) do
  ...
  create_table "item_tools", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "your_table_name", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
  end
